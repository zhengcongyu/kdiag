...
type DiagnosticIssue struct {
	...
	Summary         string                  `json:"summary"`
	ProblemAt       string                  `json:"problemAt,omitempty"`
	PossibleCauses  []string                `json:"possibleCauses,omitempty"`
	Outcome         CheckOutcome            `json:"outcome"`
	Confidence      float64                 `json:"confidence"`
	Resource        *ResourceRef            `json:"resource,omitempty"`
	Evidence        []string                `json:"evidence"`
	Troubleshooting []TroubleshootingAction `json:"troubleshooting,omitempty"`
}

// TroubleshootingAction is a safe, read-only diagnostic operation shown to
// users. Commands are generated by the API from trusted resource references;
// clients must never accept arbitrary commands as diagnosis facts.
type TroubleshootingAction struct {
	Title          string `json:"title"`
	Purpose        string `json:"purpose"`
	Command        string `json:"command,omitempty"`
	Expected       string `json:"expected"`
	IfAbnormal     string `json:"ifAbnormal"`
	ReadOnly       bool   `json:"readOnly"`
	RequiresAccess string `json:"requiresAccess,omitempty"`
}
...
type DiagnosisReport struct {
	...
	Troubleshooting   []TroubleshootingAction `json:"troubleshooting"`
